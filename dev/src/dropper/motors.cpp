...
void update_encoder() {
	...
	if (state == 0b1101 || state == 0b0100 || state == 0b0010 || state == 0b1011) { encoder_count_value++; encoder_total_cicle_count_value++; }
	if (state == 0b1110 || state == 0b0111 || state == 0b0001 || state == 0b1000) { encoder_count_value--; encoder_total_cicle_count_value--; }
